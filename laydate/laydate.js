    ...
    a.laydate = function (b) {
        ...
        (function () {
            ...
            xhr.onreadystatechange = function () {
                var time = null, d = null;
                if (xhr.readyState === 2) {
                    time = xhr.getResponseHeader("Date");
                    d = new Date(time);
                    var y = new Date(time).getTime();
...
//            b.dif = (dif ? dif : 0);
        ...
        //        console.log(date)
        //        var y = new Date(date.y,date.m,date.d,date.h,date.mi,date.s).getTime();
        //        var x = new Date().getTime();
        //        var z = y - x;
        //        console.log(z)
        //        b.dif = (z ? z : 0);
        ...
        /*---------------------------------------------------------------*/
        a < (0 | c.mins[0]) && (a = 0 | c.mins[0]), a > (0 | c.maxs[0]) && (a = 0 | c.maxs[0]),
            g.setFullYear(a, b, d),
            ...
            f.NDay = 1, c.each(h.tds, function (a, b) {
            var g, d = f.ymd[0],
                e = f.ymd[1] + 1;
        ...
        c.addClass(d.body, "laydate_body"), h.tds = b("#laydate_table td"), h.mms = b("#laydate_ms span"), h.year = b("#laydate_y"), h.month = b("#laydate_m"), c.each(b(e.box + " .laydate_ym"), function (a, b) {
            ...
            c.elem[h.elemv] = "", c.close(), ("function" == typeof c.options.clearDate && c.options.clearDate())
        ...
        var d = new Date(0 | a ? function (a) {
            return 864e5 > a ? +c.setNT() + 864e5 * a : a
        }(parseInt(a)) : +c.setNT());
        /*
         * laydate.now = function (a, b) {
         var d = new Date(0 | a ? function (a) {
        ...
        console.log("weasfasdf")
        console.log(c.setNT())

        ///  c.parse([d.getFullYear(), d.getMonth() + 1, d.getDate()], [d.getHours(), d.getMinutes(), d.getSeconds()], b)
//console.log( c.parse([d.getFullYear(), d.getMonth() + 1, d.getDate()], [d.getHours(), d.getMinutes(), d.getSeconds()], b))
        /*------------------------------------------------------*/
        return c.parse([d.getFullYear(), d.getMonth() + 1, d.getDate()], [d.getHours(), d.getMinutes(), d.getSeconds()], b)
    },
